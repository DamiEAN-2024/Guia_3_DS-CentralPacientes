...
public class PanelExtension extends JPanel implements ActionListener {
    ...
    public PanelExtension(InterfazCentralPacientes ventana) {
        ...
        // Bot�n opci�n 3
        btnOpcion3 = new JButton("Clínica Mas Ocupada");
        ...
        // Bot�n opci�n 5 Reasigna Paciente
        JButton btnReasignarPaciente = new JButton("Reasignar Paciente");
        btnReasignarPaciente.setActionCommand("ReasignarPaciente");
        btnReasignarPaciente.addActionListener(this);
        add(btnReasignarPaciente);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (comando.equals("ReasignarPaciente")) {
            principal.reasignarPaciente();
        }
    }
